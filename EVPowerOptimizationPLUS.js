...
const plugin = ({widgets, simulator, vehicle}) => {
    ...
    const updateSimulation = async () => {
        ...
        if( inf_light === 100 && temp === 15 && fan_speed === 100 && media_volume === 100) {
            IVIAnimationFrame.querySelector("#mainText").innerHTML = `Estimated travel range: ${(bat_soc*3).toFixed(2)} km <br> Distance to the nearest charging station: ${(400 - trvl_dist).toFixed(2)} km <br> Media volume: 100 <br> Interior Light System: Maximum light`;
