    ...
    return (box) => {
        ...
        * {
        ...
        <div style="height: 100%; padding: 10px; display: flex; flex-direction: column;">
            ${pills.map((pill, i ) => (`
                <div style="display: flex; height: 100%; background-image: linear-gradient(#ff5355, #ff70b5); color: white; padding: 15px; border-radius: 15px; user-select: none; align-items: center;${i !== pills.length-1 && 'margin-bottom: 7px;' }" data-signal="${pill.signal}">
