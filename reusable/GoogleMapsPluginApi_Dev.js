                  ...
                  .then(chargestationCoordinates => {
                      ...
                      for (let chargestationId in chargestationCoordinates) {
                          ...
                          chargestationMarkers[chargestationId] = new box.window.google.maps.Marker({
                              ...
                              map: map,
                              icon: icon === null ? {
                                  path: "M168 224H120c-7.25 0-12.85-5.59-11.89-11.89l16-107C124.9 99.9 129.98 96 136 96h48c7.88 0 13.62 6.54 11.6 13.21L184 160h38.7c4.24 0 6.88 4.39 4.8 7.88l-93.7 139c-2.2 3.33-6.21 5.24-10.39 5.24-7.67 0-13.47-6.28-11.67-12.92L89.35 224H32c-7.25 0-12.85-5.59-11.89-11.89l16-107C37.9 99.9 42.98 96 49 96h39.7c4.24 0 6.88 4.39 4.8 7.88l-22.7 37.76c-2.2 3.33-6.21 5.24-10.39 5.24-7.67 0-13.47-6.28-11.67-12.92L32 224H16c-8.84 0-16 7.16-16 16v32c0 8.84 7.16 16 16 16h152c8.84 0 16-7.16 16-16v-32c0-8.84-7.16-16-16-16z",
                                  fillColor: '#2563eb',
                                  fillOpacity: 1,
                                  anchor: new box.window.google.maps.Point(12,-290),
                                  strokeWeight: 0,
