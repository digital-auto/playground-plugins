    ...
    return (box) => {
        ...
        * {
        ...
        <div style="height: 100%; padding: 10px; display: flex; flex-direction: column;">
            <div style="display: flex; height: 100%; background-image: linear-gradient(#1d4882, #688cc3); color: white; padding: 15px; border-radius: 15px; user-select: none; align-items: center;" data-signal="${pill.signal}">
