    ...
    widgets.register("Score Bar", async (box) => {
        ...
        * {
		...
		<div id="score" style="">
			...
			<div id="message">Current battery SOC <img src="https://firebasestorage.googleapis.com/v0/b/digital-auto.appspot.com/o/media%2FEVIconWithOutCIF.png?alt=media&token=7337cfb3-b4f5-4b67-bfff-27a307396d4f" width="40" height="30"></div>
		</div>
			...
			<div id="message">Current battery SOC <img src="https://firebasestorage.googleapis.com/v0/b/digital-auto.appspot.com/o/media%2FEViconCIF.png?alt=media&token=4ef5caf0-f58a-4d84-924a-43db76cd6668" width="40" height="30"></div>
		</div>
		`
    ...
    tr:nth-child(even) td {
        ...
        <div style="display: flex !important; height: 100%; width: 100%;">
            <table>
                <thead>
                    <tr>
                        <th>VSS API</th><th>Value <img src="https://firebasestorage.googleapis.com/v0/b/digital-auto.appspot.com/o/media%2FEVIconWithOutCIF.png?alt=media&token=7337cfb3-b4f5-4b67-bfff-27a307396d4f" width="40" height="30">
                        </th><th>Value <img src="https://firebasestorage.googleapis.com/v0/b/digital-auto.appspot.com/o/media%2FEViconCIF.png?alt=media&token=4ef5caf0-f58a-4d84-924a-43db76cd6668" width="40" height="30"></th>
                    </tr>
                </thead>
                <tbody>
    ...
    widgets.register("ImageType",  box => {
     ...
     widgets.register("Cover",  box => {
       ...
       widgets.register("MapsLegend",  box => {
        ...
        container.innerHTML = `
        <img width="100%" height="100%" style="border-style: solid;border-color: #3b3b71;" src="https://firebasestorage.googleapis.com/v0/b/digital-auto.appspot.com/o/media%2FinfoMap.png?alt=media&token=7a60aade-c61f-4a56-a61b-2eecd33e1479" >
