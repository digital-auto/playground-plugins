    ...
    widgets.register("Policy Selection", async (box) => {
        ...
        * {
        ...
        <div style="display:flex;flex-wrap:wrap;flex-direction:column;align-content:space-around;jusstify-content:space-around">
            ...
            <button id="pol11" class="pol" style="width:140px;max-width:140px;background-color: rgb(157 176 184);padding: 10px 24px;cursor: pointer;margin:2px;border-radius:5px;font-size:1em;font-family:Lato;color: rgb(255, 255, 227);border:0px">
            No policy
            </button>
            <br>
